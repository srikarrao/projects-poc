...
public class ObjectTester {
	public static void main(String args[]) {
		Student s1 = new Student("Valentino Rossi", "Italy", 1, "Felloni");
		Student s2 = new Student("Suresh", null, 3, null);

		System.out.println(s1.equals(s2));
		System.out.println(s1.hashCode());
		System.out.println(Objects.toStringHelper(s1)
				.add("Name", s1.getFirstName() + " " + s1.getLastName())
				.add("Class", s1.getClassName()).add("Roll No", s1.getRollNo())
				.toString());
	}
}
...
class Student {
	...
	public boolean equals(Object object) {
		...
		return Objects.equal(firstName, student.firstName) // first name can be
															// null
				&& Objects.equal(lastName, student.lastName) // last name can be
																// null
				&& Objects.equal(rollNo, student.rollNo)
				&& Objects.equal(className, student.className);// class name can
																// be null
	}
