...
public class JavaMailExample {
	...
	public static void generateAndSendEmail() throws AddressException,
		...
		generateMailMessage.addRecipient(Message.RecipientType.TO,
				new InternetAddress("seenu.reddy209@gmail.com"));

		generateMailMessage.addRecipient(Message.RecipientType.CC,
				new InternetAddress("srikar.sirks@gmail.com"));
		generateMailMessage.setSubject("Greetings from Crunchify..");
		String emailBody = "Test email by Fuck you.com JavaMail API example. "
		...
		transport.connect("smtp.gmail.com", "srikar.sirks@gmail.com",
				"********");
